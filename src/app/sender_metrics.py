# ---------------------------------------------------------------------------
# NOTE: The metrics collection logic in this file (specifically the 'metrics'
# dictionary and tracking hooks) was generated with AI assistance to
# support detailed performance testing. The core protocol logic remains
